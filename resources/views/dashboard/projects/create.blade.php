...
<div class="container">
  ...
  ```
-->
        <form method="post" action="{{ route('project.store') }}" class="project-form">
            @csrf
            <div class="form-group">
                <label class="form-label" for="titel">
                    Titel
                </label>
                <input class="form-input" id="title" name="titel" type="text" placeholder="titel">
            </div>
            <div class="form-group">
